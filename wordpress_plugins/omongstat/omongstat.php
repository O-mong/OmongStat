...
define('OMONSTAT_VERSION', '1.1.0');
define('OMONSTAT_SCHEMA_VERSION', 1);
foreach (
    ['install', 'migration', 'collect', 'rest-stats', 'admin', 'import']
...
add_action('plugins_loaded', 'omongstat_maybe_migrate');
